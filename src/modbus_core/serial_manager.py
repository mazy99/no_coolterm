...
# Класс конфигурации (добавлен, так как его не было в файле одногруппника)
class ModbusConfig:
    """Конфигурация COM-порта для Modbus"""
    def __init__(self, port: str, baudrate: int = 9600, byte_size: int = 8, 
                 parity: str = 'N', stopbits: float = 1.0, timeout: int = 1):
        self.port = port
